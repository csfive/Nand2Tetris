...
\overline{a \cdot b} &= \overline{a} + \overline{b} \quad \text{(第二定律)} \\[8pt]

Not(a) &= \overline{a} = \overline{a \cdot a} \quad \text{(a + a = a)} \\
And(a, b) &= a \cdot b = \overline{\overline{a \cdot b}} \\
Or(a, b) &=  a + b = \overline{\overline{a} \cdot \overline{b} } \\[8pt]
...
&= \overline{\overline{ a (\overline{a \cdot b} )} \cdot \overline{b (\overline{a \cdot b}) }}\\[8pt]

Mux(a, b, sel) &= a \cdot \overline{sel} + b \cdot sel \\
&= \overline{\overline{a \cdot \overline{sel} + b \cdot sel}} \\
&= \overline{\overline{a \cdot \overline{sel}} \cdot \overline{b \cdot sel}} \\[8pt]
...
> 挑战了下自己，只用 Nand 门实现了基础芯片，详见 [GitHub 仓库](https://github.com/csfive/Nand2Tetris/tree/main/projects/01)
